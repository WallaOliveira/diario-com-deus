...
const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    description: 'Vou mostrar onde estão as principais funcionalidades do app. Levará apenas 1 minuto!',
    position: 'center',
  },
  {
  ...
  {
    title: '💜 Devocional Pessoal',
    description: 'Escolha o tema que você precisa hoje: ansiedade, gratidão, perdão, sabedoria, família, trabalho... Seu momento personalizado com Deus.',
    targetSelector: '.modo-livre-card',
    position: 'bottom',
  },
  {
    title: '🗺️ Trilhas Devocionais',
    description: 'Jornadas de 7, 14 ou 30 dias sobre temas profundos. Ideal para crescimento contínuo e transformação real na sua fé!',
    targetSelector: '.trilhas-card',
    position: 'bottom',
  },
  {
    title: '🎁 Trilhas Especiais',
    description: 'Conteúdos avançados, planos personalizados e materiais exclusivos para aprofundar sua jornada espiritual.',
    targetSelector: '.trilhas-especiais-card',
    position: 'bottom',
  },
  {
    title: '📊 Seu Progresso',
    description: 'Acompanhe sua jornada, sequência de dias e conquistas. Lembre-se: sem culpa, só recomeço! Cada dia é uma nova oportunidade.',
    targetSelector: '.progresso-card',
    position: 'top',
  },
  {
    title: '🎁 Bônus Gratuitos',
    description: 'Wallpapers para tela de bloqueio, guias em PDF, playlists de adoração e muito mais conteúdo especial sem custo!',
    targetSelector: '.bonus-card',
    position: 'top',
  },
  {
    title: '✨ Pronto para Começar!',
    description: 'Dica de ouro: faça seu devocional no mesmo horário todos os dias. Crie o hábito e veja a transformação! Você pode rever este tutorial a qualquer momento clicando no ícone ? no canto da tela.',
    position: 'center',
  },
];
